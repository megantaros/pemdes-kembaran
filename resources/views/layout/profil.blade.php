...
<body class="bg-[#F0F4F4]">
    ...
    <div id="headerService" class="bg-primary min-h-[40vh]"></div>
    <div data-aos="fade-up" class="container -mt-60 mb-10">
        <div class="grid lg:grid-cols-4 md:grid-cols-1 grid-cols-1 gap-4">
            <div class="card bg-white shadow-lg h-fit">
                <div class="card-body">
    ...
    <footer data-aos="fade-up" class="bg-primary">
        <div class="container">
    ...
    <script>
        @if (Session::has('error'))
            swal("{{ Session::get('error') }}", "Mohon Maaf", "error");
        @endif
    </script>
</html>