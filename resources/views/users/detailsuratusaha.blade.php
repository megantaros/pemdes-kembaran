...
@section('title', 'Detail Surat Keterangan Usaha')
        ...
        <div class="container absolute py-14 left-1/2 transform -translate-x-1/2">
            <div class="flex lg:flex-row flex-col gap-4">
                <div class="basis-1/3 bg-white lg:h-100vh w-full rounded-lg p-6 shadow-lg lg:relative">
                    <div class="flex flex-row gap-4">
                        ...
                        <div class="flex flex-col pt-1">
                            ...
                            <div class="">
                                <a href="{{ route('info.warga') }}" class="flex text-[#C6C6C6] hover:text-[#C6C6C6] hover:underline text-md">
                ...
                <div class="basis-1/1 bg-white h-auto w-full rounded-lg p-6 shadow-lg">
                    <div class="lg:text-3xl text-2xl">Detail Surat Keterangan Usaha</div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="table w-full tabel-surat border-none">
                            ...
                            <form action="{{ route('keterangan-usaha.update', ['keterangan_usaha' => $data->id_surat_ket_usaha]) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('PUT')
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="select select-primary w-full mb-3" name="status_pernikahan">
                                ...
                                <tr>
                                    ...
                                    <td>                       
                                        <input type="text" placeholder="Tulis disini..." class="input input-bordered input-info w-full read-only:bg-[#9cb4cc]" value="{{ $data->jenis_usaha }}" name="jenis_usaha"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">Tempat Usaha</th>
                                    <td>                       
                                        <input type="text" placeholder="Tulis disini..." class="input input-bordered input-info w-full read-only:bg-[#9cb4cc]" value="{{ $data->tempat_usaha }}" name="tempat_usaha"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">Lama Usaha</th>
                                    <td>                       
                                        <input type="text" placeholder="Tulis disini..." class="input input-bordered input-info w-full read-only:bg-[#9cb4cc]" value="{{ $data->lama_usaha }}" name="lama_usaha"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="w-full h-full"><input type="file" class="file-input file-input-bordered file-input-primary w-full mt-2" accept="image/png, image/jpeg" name="fc_ktp"/></div>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">Fotokopi KK</th>
                                    <td>
                                        <img src="{{ asset('berkaspemohon/'.$data->fc_kk) }}" class="w-50 border rounded" />
                                        <div class="w-full h-full"><input type="file" class="file-input file-input-bordered file-input-primary w-full mt-2" accept="image/png, image/jpeg" name="fc_kk"/></div>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">Aksi</th>
                                    <td class="flex justify-center">
                                        <button type="submit" class="btn btn-warning w-50 my-5 text-lg capitalize font-semibold"><i class="bi bi-pencil-fill me-2"></i>Edit</button>
                                    </td>
                                </tr>
                            </form>
                            </tbody>
...
<div class="lg:col-span-3">
    <div class="card bg-white min-h-screen shadow-lg">
        <div class="card-body">
            ...
            <form action="{{ route('keterangan-usaha.update', ['keterangan_usaha' => $data->id_surat_ket_usaha]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="p-4 bg-slate-200 rounded-lg gap-1 grid lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select class="select select-primary w-full my-1" name="kewarganegaraan">
                            <option selected value="{{ $data->kewarganegaraan }}" disabled>{{ $data->kewarganegaraan }}</option>
                            <option value="WNI">WNI</option>
                            <option value="WNA">WNA</option>
                        </select>
                    ...
                    <div>
                        <div class="text-label text-sm">Status Pernikahan *</div>
                        <select class="select select-primary w-full my-1" name="status_pernikahan">
                            <option selected value="{{ $data->status_pernikahan }}">{{ $data->status_pernikahan }}</option>
                            <option value="Belum Kawin">Belum Kawin</option>
                            <option value="Kawin">Kawin</option>
                        </select>
                    ...
                    <div>
                        <div class="text-label text-sm">Jenis Usaha *</div>
                        <input type="text" placeholder="Contoh: Pedagang Lotek" class="input input-bordered input-primary w-full my-1 read-only:bg-[#9cb4cc] placeholder:text-sm" name="jenis_usaha" value="{{ $data->jenis_usaha }}"/>
                    ...
                    <div>
                        <div class="text-label text-sm">Lama Usaha *</div>
                        <input type="text" placeholder="Contoh: 2 Tahun" class="input input-bordered input-primary w-full my-1 read-only:bg-[#9cb4cc] placeholder:text-sm" name="lama_usaha" value="{{ $data->lama_usaha }}"/>
                    ...
                    <div class="lg:col-span-2">
                        <div class="text-label text-sm">Tempat Usaha *</div>
                        <textarea class="textarea textarea-primary w-full placeholder:text-sm" placeholder="Masukkan Tempat Usaha" name="tempat_usaha">{{ $data->tempat_usaha }}</textarea>
                    </div>
                    ...
                    <div class="p-4 bg-white rounded-lg relative lg:col-span-2 flex items-center border-[#9CB4CC] border-2 my-1">
                        ...
                        <div class="flex-1">
                            ...
                            <label for="fileUpload4" class="text-label text-sm custom-file-upload cursor-pointer flex gap-2 items-center hover:underline">
                                <i class="fa fa-upload" aria-hidden="true"></i>
                                <span>Upload Foto Usaha</span>
                            </label>
                            <input type="file" id="fileUpload4" class="hidden" accept="image/png, image/jpeg" name="foto_usaha" />
    
                            <p class="text-sm font-semibold mt-2">{{ $data->foto_usaha != null ? $data->foto_usaha : 'Belum Upload File' }}</p>
    
                        </div>
    
                        <a href="{{ url('berkaspemohon/'. $data->foto_usaha) }}" target="__blank" class="text-sm hover:underline text-blue-600">
                            <i class="fa fa-eye" aria-hidden="true"></i>
                            <span>Lihat Gambar</span>
                        </a>
