        ...
        <div class="container absolute py-14 left-1/2 transform -translate-x-1/2">
            <div class="flex lg:flex-row flex-col gap-4">
                ...
                <div class="basis-1/1 bg-white h-auto w-full rounded-lg p-6 shadow-lg">
                    <div class="lg:text-3xl text-2xl">Detail Surat Pengantar SKCK</div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="table w-full tabel-surat border-none">
                            ...
                            <form action="{{ route('pengantar-skck.update', ['pengantar_skck' => $data->id_surat_peng_skck]) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('PUT')
                            <tr>
                                <th scope="row">No. KK</th>
                                <td>                       
                                    <input type="number" placeholder="Tulis disini..." class="input input-bordered input-info w-full read-only:bg-[#9cb4cc]" value="{{ $data->kk }}" name="kk"/>
                                </td>
                            </tr>
                            <tr>
...
<div class="lg:col-span-3">
    <div class="card bg-white min-h-screen shadow-lg">
        <div class="card-body">
            ...
            <div>
                <h2 class="lg:text-lg md:text-sm text-sm font-semibold">Detail Surat Pengantar SKCK</h2>
                <div class="flex">
