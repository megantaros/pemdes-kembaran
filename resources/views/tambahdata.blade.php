...
<html lang="en">
  ...
  <body>
    <div class="container">
        <h1 class="text-center my-3">Tambah Data Pegawai</h1>
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <form action="/insertdata" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan No. Telephone" name="notelpon">
                        </div>
                        <div class="mb-3">
                            <label for="formGroupExampleInput2" class="form-label">Masukkan Foto</label>
