...
<html lang="en">
  ...
  <body>
    <div class="lg:h-[100vh]">
      <section id="lengkapi-profil">
          <div class="lg:h-[70vh] relative" style="background: #022E57;">
              <div class="text-center lg:w-1/2 mx-auto lg:pt-[120px] md:pt-[50px] pt-[50px]">
                  <div class="lg:text-5xl mb-3" style="color: #FFEBAD;">Lengkapi Profil Anda</div>
                  <div class="text-xl mb-5 text-white textPortal">Sebelum mengajukan permohonan administrasi, pemohon dimohon untuk melengkapi profil terlebih dahulu guna memperlancar proses administrasi </div>
              </div>
              <div class="block p-6 rounded-md shadow-lg bg-white lg:w-[1000px] md:w-[10px] mt-12 m-auto border-l-[15px] border-l-[#FFEBAD]">
                <form action="/lengkapiprofil" method="POST">
                  @csrf
                  @method('put')
                  ...
                  <button type="submit" class="btn btn-primary w-100 mt-3 text-white">Kirim</button>
                </form>
              </div>
          </div>
      </section>
