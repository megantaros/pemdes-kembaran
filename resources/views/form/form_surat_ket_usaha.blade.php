        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body gap-10">
                ...
                <div class="card-title bg-slate-200 p-4 rounded-lg">
                    <div class="m-auto">
                        <h2 class="text-lg leading-1">Form Pengisian Surat Keterangan Usaha</h2>
                ...
                <form class="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 text-left gap-6" action="{{ route('keterangan-usaha.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    ...
                    <div class="p-4 bg-slate-200 rounded-lg">
                        ...
                        <input type="text" placeholder="Contoh: Pedagang Lotek" class="input input-bordered input-primary w-full my-1 read-only:bg-[#9cb4cc] placeholder:text-sm" name="jenis_usaha"/>
                        ...
                        <textarea class="textarea textarea-primary w-full placeholder:text-sm" placeholder="Masukkan Tempat Usaha Secara Lengkap" name="tempat_usaha"></textarea>
                        ...
                        <input type="text" placeholder="Contoh: 2 Tahun" class="input input-bordered input-primary w-full my-1 read-only:bg-[#9cb4cc] placeholder:text-sm" name="lama_usaha"/>
                    ...
                    <div class="p-4 bg-slate-200 rounded-lg">
                        ...
                        <div class="text-label text-sm">Surat Pengantar *</div>
                        ...
                        <div class="text-label text-sm">Foto Usaha *</div>
                        <input type="file" class="input input-bordered input-primary w-full file-input-primary file:border-none file:py-1 my-1" accept="image/png, image/jpeg"  name="foto_usaha"/>
