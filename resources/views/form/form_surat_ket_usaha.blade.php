    ...
    <section id="service" class="lg:pt-14 lg:pb-20 pt-7 pb-10">
        <div class="container text-center">
            ...
            <div class="card lg:card-side bg-base-100 shadow-xl border-none">
                <div class="card-body">
                <form action="/layanan/{{ $id_surat_pengajuan }}/surat_ket_usaha" method="POST" enctype="multipart/form-data">
                @csrf
                    <h1 class="card-title lg:text-3xl text-2xl w-100 flex justify-center">Pengajuan Surat Keterangan Usaha</h1>
                    ...
                    <div class="p-5 rounded-lg" style="background-color: #ffebae">
                        ...
                        <div class="text-label">Kewarganegaraan *</div>
                        <select class="select select-primary w-full my-1" name="kewarganegaraan">
                            <option value="WNI">WNI</option>
                            <option value="WNA">WNA</option>
                        </select>
                        <div class="text-label">Status Pernikahan *</div>
                        <select class="select select-primary w-full my-1" name="status_pernikahan">
                            <option value="Belum Kawin">Belum Kawin</option>
                            <option value="Kawin">Kawin</option>
                        </select>
                        <div class="text-label">Jenis Usaha *</div>
                        <input type="text" placeholder="Contoh: Pedagang Lotek" class="input input-bordered input-info w-full my-1 read-only:bg-[#9cb4cc]" name="jenis_usaha"/>
                        @error('jenis_usaha')
                            <div class="alert alert-error shadow-lg text-white w-full m-auto my-1">
                                <div>
                        ...
                        @enderror
                        <div class="text-label">Tempat Usaha *</div>
                        <textarea class="textarea textarea-info w-full my-1" placeholder="Contoh: Desa Kembaran, Kebumen" name="tempat_usaha"></textarea>
                        @error('tempat_usaha')
                            <div class="alert alert-error shadow-lg text-white w-full m-auto my-1">
                                <div>
                                <i class="bi bi-x-circle"></i>
                        ...
                        @enderror
                        <div class="text-label">Lama Usaha *</div>
                        <input type="text" placeholder="Contoh: 2 Tahun" class="input input-bordered input-info w-full my-1 read-only:bg-[#9cb4cc]" name="lama_usaha"/>
                        @error('lama_usaha')
                            <div class="alert alert-error shadow-lg text-white w-full m-auto my-1">
                                <div>
                                <i class="bi bi-x-circle"></i>
                    ...
                    <div class="p-5 rounded-lg" style="background-color: #ffebae">
                        ...
                        @enderror
                        <div class="text-label">Foto Usaha *</div>
                        <input type="file" placeholder="Unggah Dokumen Fotokopi KK" class="file-input file-input-bordered file-input-primary w-full my-1" accept="image/png, image/jpeg"  name="foto_usaha"/>
                        @error('foto_usaha')
                        <div class="alert alert-error shadow-lg text-white w-full m-auto my-1">
                            <div>
                            <i class="bi bi-x-circle"></i>
