    ...
    <section id="service" class="lg:pt-14 lg:pb-20 pt-7 pb-10">
        <div class="container text-center">
            ...
            <div class="card lg:card-side bg-base-100 shadow-xl border-none">
                <div class="card-body">
                <form action="/layanan/{{ $id_surat_pengajuan }}/surat_peng_skck" method="POST" enctype="multipart/form-data">
                @csrf
                    <h1 class="card-title lg:text-3xl text-2xl w-100 flex justify-center">Pengajuan Surat Pengantar SKCK</h1>
