    ...
    <section id="service" class="lg:pt-14 lg:pb-20 pt-7 pb-10">
        <div class="container text-center">
            ...
            <div class="card lg:card-side bg-base-100 shadow-xl border-none">
                <div class="card-body">
                <form action="/layanan/{{ $id_surat_pengajuan }}/surat_ket_pindah_datang" method="POST" enctype="multipart/form-data">
                @csrf
                    <h1 class="card-title lg:text-3xl text-2xl w-100 flex justify-center">Pengajuan Surat Keterangan Pindah Datang</h1>
                    ...
                    <div class="p-5 rounded-lg" style="background-color: #ffebae">
                        ...
                        <div class="divider before:bg-primary before:h-[3px] my-2"></div>
                        <div class="text-label">Foto Surat Ket. Pindah dari CAPIL *</div>
                        <input type="file" placeholder="Unggah Dokumen Pengantar RT" class="file-input file-input-bordered file-input-primary w-full my-1" accept="image/png, image/jpeg" name="foto_surat_ket_pindah_capil"/>
                        @error('foto_surat_ket_pindah_capil')
                        <div class="alert alert-error shadow-lg text-white w-full m-auto my-1">
                            <div>
