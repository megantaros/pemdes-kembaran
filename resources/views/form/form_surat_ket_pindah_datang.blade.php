        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body gap-10">
                ...
                <div class="card-title bg-slate-200 p-4 rounded-lg">
                    <div class="m-auto">
                        <h2 class="text-lg leading-1">Form Pengisian Surat Keterangan Pindah Datang</h2>
                ...
                <form class="grid lg:grid-cols-1 text-left gap-6" action="{{ route('keterangan-datang.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    ...
                    <div class="p-4 bg-slate-200 rounded-lg">
                        ...
                        <div class="text-label text-sm">Surat Keterangan Pindah dari CAPIL *</div>
                        <input type="file" class="input input-bordered input-primary w-full file-input-primary file:border-none file:py-1 my-1" accept="image/png, image/jpeg" name="foto_surat_ket_pindah_capil"/>
