        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body gap-10">
                ...
                <div class="card-title bg-slate-200 p-4 rounded-lg">
                    <div class="m-auto">
                        <h2 class="text-lg leading-1">Form Pengisian Surat Pengantar KTP</h2>
                ...
                <form class="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 text-left gap-6" action="{{ route('pengantar-ktp.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    ...
                    <div class="p-4 bg-slate-200 rounded-lg">
                        ...
                        <input type="file" placeholder="Unggah Dokumen Pengantar RT" class="input input-bordered input-primary w-full file-input-primary file:border-none file:py-1 my-1" accept="image/png, image/jpeg" name="pengantar_rt"/>
                        ...
                        <input type="file" placeholder="Unggah Dokumen Pengantar RT" class="input input-bordered input-primary w-full file-input-primary file:border-none file:py-1 my-1" accept="image/png,image/jpeg" name="foto_ktp"/>
                        ...
                        <input type="file" placeholder="Unggah Dokumen Fotokopi KK" class="input input-bordered input-primary w-full file-input-primary file:border-none file:py-1 my-1" accept="image/png,image/jpeg"  name="foto_kk"/>
                        @error('foto_kk')
                        <div class="alert alert-error shadow-lg text-white w-full m-auto my-1">
                            <div>
                            <i class="bi bi-x-circle"></i>
