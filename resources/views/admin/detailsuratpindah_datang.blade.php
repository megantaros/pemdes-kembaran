            ...
            <div class="p-4 bg-white rounded-lg relative lg:col-span-2 flex items-center border-[#9CB4CC] border-2 my-1">
                ...
                <div class="flex flex-1 items-center gap-4">
                  ...
                  <div class="h-20 border-2 bg-primary rounded-lg p-2 overflow-hidden w-32">
                    <img src="{{ url('berkaspemohon/'. $data->foto_surat_ket_pindah_capil ) }}" alt="Surat Keterangan Pindah dari Capil" class="rounded-sm h-20 object-cover m-auto">
                  </div>
  
                  <div>
                    <h2 class="font-semibold">Surat Keterangan Pindah dari Capil</h2>
                    <p class="text-sm font-semibold text-gray-500">{{ $data->foto_surat_ket_pindah_capil != null ? $data->foto_surat_ket_pindah_capil : 'Belum Upload File' }}</p>
                  </div>
