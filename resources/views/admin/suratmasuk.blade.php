        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('suratmasuk') }}">Surat Masuk</a></li>
      ...
      <div class="container-fluid">
          <div class="card p-4">
            ...
            <form action="{{ route('suratmasuk') }}">
              ...
              {{-- <form action="{{ route('cetaksuratmasuk') }}">
                <button type="submit" class="btn btn-success ml-2"><i class="fa fa-print mr-1" aria-hidden="true"></i>Cetak PDF</button>
              </form> --}}
          </div>
