          ...
          <div class="gap-1 grid lg:grid-cols-2">
            ...
            <div>
              <div class="text-label text-sm">Status Hubungan Dalam Keluarga *</div>
                <input type="text" placeholder="Masukkan No. KK" class="input input-bordered input-primary w-full my-1 read-only:bg-[#9cb4cc] placeholder:text-sm" name="shdk" value="{{ $data->shdk }}" disabled/>
            </div>
            ...
            <div class="p-4 bg-white rounded-lg relative lg:xl:col-span-2 lg:col-span-2 md:col-span-2 col-span-1 flex items-center border-[#9CB4CC] border-2 my-1">
              ...
              <div class="flex flex-1 items-center gap-4">
                ...
                <div class="h-20 border-2 bg-primary rounded-lg overflow-hidden w-32">
                  <img src="{{ url('berkaspemohon/'. $data->fc_buku_nikah ) }}" alt="Fotokopi Buku Nikah" class="rounded-sm object-cover w-full h-full">
                </div>
  
                <div>
                  <h2 class="font-semibold">Fotokopi Buku Nikah</h2>
                  <p class="xl:text-sm lg:text-sm md:text-sm text-xs font-normal text-gray-500">{{ $data->fc_buku_nikah != null ? $data->fc_buku_nikah : 'Belum Upload File' }}</p>
                </div>
