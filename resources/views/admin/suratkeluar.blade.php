      ...
      <div class="container-fluid">
          <div class="card p-4">
            ...
            <form action="{{ route('suratkeluar') }}">
              ...
              <form action="{{ route('cetaksuratkeluar') }}">
                <button type="submit" class="btn btn-success ml-2"><i class="fa fa-print mr-2" aria-hidden="true"></i>Cetak PDF</button>
              </form>
          </div>
